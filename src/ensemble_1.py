...
resources = pd.read_csv('/home/dulanga/Documents/Python/resources.csv').sort('projectid')
...
print(len(resources.projectid))
print(len(resources.project_resource_type))
...
temp_df = pd.DataFrame(proj_type,
                       columns=['projectid', 'resource_a', 'resource_b', 'resource_c', 'resource_d', 'resource_e',
                                'resource_f', 'resource_g'])
del proj_type
del resources
...
cols = ['teacher_acctid', 'schoolid', 'school_city', 'school_state', 'school_district', 'school_county',
        ...
        'student', 'essay_length', 'resource_a', 'resource_b', 'resource_c', 'resource_d', 'resource_e', 'resource_f',
        'resource_g']
...
sample.to_csv('predictions_v2.csv', index=False)
